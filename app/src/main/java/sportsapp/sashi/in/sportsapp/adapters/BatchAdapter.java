...
import sportsapp.sashi.in.sportsapp.ui.fragments.VideoOfDayFragment;
import sportsapp.sashi.in.sportsapp.viewholders.BatchFooterViewHolder;
import sportsapp.sashi.in.sportsapp.viewholders.BatchItemsViewHolder;
...
public class BatchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BatchAdapter(Context context, List<Batch> itemsList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof BatchItemsViewHolder){
            ...
            final BatchFooterViewHolder footerViewHolder = (BatchFooterViewHolder) holder;
